...
import com.eduardogabriel.applicationmongo.resources.util.URL;
import com.eduardogabriel.applicationmongo.services.PostService;
...
public class PostResource {
	...
	public ResponseEntity<List<Post>> findByTitle(@RequestParam String text) {		
		...
		List<Post> posts = service.findByTitulo(text);
